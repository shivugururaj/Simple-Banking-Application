...
public class WithdrawAction extends ActionSupport{
	...
	public WithdrawAction(String transactionId, String toAccountNo,
	...
	public String toString() {
		return "WithdrawAction [transactionId=" + transactionId
	...
	if(ifobj.withdraw(toAccountNo, amount, paymentMode, transactionDate,fromAccount )==true)
	{
